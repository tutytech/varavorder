                                  ...
                                  _filteredBranches.map((branch) {
                                    return DataRow(
                                      cells: [
                                        ...
                                        DataCell(
                                          Text(
                                            branch['productcode']?.toString() ??
                                                '0',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['productname']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
                                        ...
                                        DataCell(
                                          Text(
                                            branch['purchaseqty']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['salesunit']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['salesqty']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['salesrate']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['wholesalerate']
                                                    ?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        ...
                                        DataCell(
                                          Text(
                                            branch['mrp']?.toString() ?? 'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['gst']?.toString() ?? 'N/A',
                                          ),
                                        ),
                                        DataCell(
                                          Text(
                                            branch['gsttype']?.toString() ??
                                                'N/A',
                                          ),
                                        ),
                                        DataCell(
